<%-- 
    Document   : reg1
    Created on : 2 Mar, 2020, 12:03:50 PM
    Author     : Mav
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function varifyUserid(x, y) {
                ...
                ajax = new XMLHttpRequest();
                ajax.open("GET", "UserController?op=varifyC&contact=" + x, true);
                ajax.send();
                    ...
                    <form  action="reg2.jsp" method="post" class="form" onsubmit="return comparePwds(password.value, rpassword.value);">  
                        <center
                            ...
                            <table class="table bg-light"> 
                                ...
                                <td><input type="number" name="contact"   value="${user.contact}"class="form-control" onblur="varifyContact(this.value, s2);"/></td>
                                <span id="s2"> </span>
                                </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <th>   <input type="submit" value="Save and next" class="form-control btn btn-primary" disabled="disabled" id="submit" name="submit"/> 
                                    </th>
                                </tr>
